...
namespace ComplyX.Services
{
    public interface IEmployeeServices
    {
        ...
        Task<ManagerBaseResponse<IEnumerable<Employee>>> GetEmployeeDataFilter(PagedListCriteria PagedListCriteria);
        ...
        Task<ManagerBaseResponse<IEnumerable<GratuityPolicy>>> GetGratuity_PolicyFilter(PagedListCriteria PagedListCriteria);
        ...
        Task<ManagerBaseResponse<IEnumerable<GratuityTransaction>>> GetGratuity_TransactionsFilter(PagedListCriteria PagedListCriteria);
        ...
        Task<ManagerBaseResponse<IEnumerable<FnFCalculation>>> GetFnF_CalculationsFilter(PagedListCriteria PagedListCriteria);
