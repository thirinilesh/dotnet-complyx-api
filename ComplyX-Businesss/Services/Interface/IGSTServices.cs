...
namespace ComplyX_Businesss.Services.Interface
{
    public interface IGSTServices
    {
        ...
        Task<ManagerBaseResponse<IEnumerable<GSTHSNSACResponseModel>>> GetGST_HSNSACFilter(PagedListCriteria PagedListCriteria);
        ...
        Task<ManagerBaseResponse<IEnumerable<GSTHSNMappingResponseModel>>> GetGST_HSN_MappingFilter(PagedListCriteria PagedListCriteria);
        ...
        Task<ManagerBaseResponse<IEnumerable<GstInvoiceSeriesResponseModel>>> GetGST_InvoiceSeriesFilter(PagedListCriteria PagedListCriteria);
        ...
        Task<ManagerBaseResponse<IEnumerable<GstPurchaseResponseModel>>> GetGST_PurchaseFilter(PagedListCriteria PagedListCriteria);
