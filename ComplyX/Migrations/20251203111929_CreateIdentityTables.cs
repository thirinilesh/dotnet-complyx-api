    ...
    public partial class CreateIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountOwners", x => x.AccountOwnerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedDeniedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ApprovedDeniedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
